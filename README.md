...
- Memi — https://github.com/sarveshsea/memi — Agent design CI and interface understanding for coding agents, with four focused Agent Skills and 47 MCP tools for UI audits, tokens, accessibility, component scaffolds, and quality gates.
