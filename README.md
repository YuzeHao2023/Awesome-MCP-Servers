...
- YIELD INTELLIGENCE (Hosted remote MCP server for passive income analysis — Treasury rates, dividend ETFs, REITs, and portfolio optimization. No API key required.) — https://github.com/thebrierfox/intuitek-ace
