...
- X/Twitter (GetXAPI) — https://github.com/getxapi/getxapi-mcp (44 endpoints: reads search + profiles + follower graph + timeline + bookmarks + mentions; writes post + like + retweet + follow + DM + articles; bearer-token auth)
