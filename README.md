...
- agent-qa — https://github.com/vostride/agent-qa — Local MCP server for authoring, running, validating, and triaging natural-language web and mobile QA tests with execution memory.
