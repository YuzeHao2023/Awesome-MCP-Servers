...
- ToolPipe — https://github.com/COSAI-Labs/make-money-30day-challenge/tree/master/products/mcp-server — 230+ developer utility tools via MCP: JSON, QR codes, hashing, UUID, DNS, WHOIS, PDF, code review, fake data, web scraping, SEO, and more. Install: `npx @cosai-labs/toolpipe-mcp-server`. [toolpipe.dev](https://toolpipe.dev)
