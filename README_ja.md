...
モデルコンテキストプロトコル（MCP）のサーバー、ツール、フレームワーク、クライアント、ユーティリティを集めた、コミュニティ主導の厳選リストです。MCP は、AI モデルが標準化されたサーバー実装を通じてローカルおよびリモートのリソースと安全にやり取りできるようにするオープンプロトコルです。このリストは、ファイルアクセス、データベース接続、API 統合、その他のコンテキストサービスを通じて AI の機能を拡張する、実用段階および実験的な MCP サーバーに焦点を当てています。
...
[MCP](https://modelcontextprotocol.io/)（Model Context Protocol）は、AI モデルが標準化されたサーバー実装を通じてローカルおよびリモートのリソースと安全にやり取りできるようにするオープンプロトコルです。このリストは、ファイルアクセス、データベース接続、API 統合、その他のコンテキストサービスを通じて AI の機能を拡張する、実用段階および実験的な MCP サーバーに焦点を当てています。
